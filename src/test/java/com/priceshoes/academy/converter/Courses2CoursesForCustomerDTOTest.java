...
class Courses2CoursesForCustomerDTOTest {

    private final Courses2CoursesForCustomerDTO subject = new Courses2CoursesForCustomerDTO(new CustomerCourse2CourseForCustomerDTO());
    ...
    void apply() {
        ...
        var actual = subject.apply(List.of(course), List.of(customerCourse), customerId);

        assertEquals(actual.getFirst().getCustomerId(), customerId);
    }
}