...
class Course2CourseForCustomerDTOTest {

    private final Course2CourseForCustomerDTO subject = new Course2CourseForCustomerDTO();
    ...
    void apply() {
        ...
        var actual = subject.apply(courseCategory, Optional.of(customerCourse));
